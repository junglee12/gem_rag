...
# --- File Loaders ---
def load_pdf(file: st.UploadedFile, analyze_images: bool, gen_model_name: str) -> Optional[str]:
...
def load_docx(file: st.UploadedFile) -> Optional[str]:
...
def load_excel(file: st.UploadedFile) -> Optional[str]:
...
def load_image(file: st.UploadedFile, gen_model_name: str) -> Optional[str]:
